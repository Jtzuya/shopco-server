...
const getCollectionProductsByIdRoute = Router()

class CollectionProductsById {
...
const { execute } = new CollectionProductsById()
getCollectionProductsByIdRoute.get('/collection-products/:collection_id', execute)

export default getCollectionProductsByIdRoute
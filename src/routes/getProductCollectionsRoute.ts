...
const getProductCollectionsRoute = Router();

getProductCollectionsRoute.get('/product-collections', async(req: Request, res: Response) => {
  console.log('test')
  try {
...
export default getProductCollectionsRoute